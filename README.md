...
1.  **Clone the repository**
    ```bash
    git clone https://github.com/lelextb/PrecisionCalc.git
    cd PrecisionCalc
    ```
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/lelextb/PrecisionCalc/blob/main/license) file for details.
